...
const Note = ({ id, title, description, createdAt }) => {
  return (
    <Link to={`/notes/note/${id}`}>
      <div className="note hover:scale-90 bg-secondary dark:bg-dark-primary shadow-sm border border-muted dark:border-accent-1 rounded-xl p-4 transition-all duration-200 relative">
        <div className="mb-4">
