...
const Note = ({ id, title, description, createdAt }) => {
  return (
    <div className="bg-secondary dark:bg-dark-primary shadow-sm border border-muted dark:border-accent-1 rounded-lg p-4 md:p-6 transition-colors duration-100 relative">
      <div className="mb-4">
